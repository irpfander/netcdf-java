...
public class RunTimeLoadingTutorial {
    ...
    public static void FeatureDatasetFactoryRegister(FeatureType yourFeatureType, String yourClassNameAsString) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
    ...
    public static void BUFRTableRegister(String yourLookupFileNameAsString) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        ucar.nc2.iosp.bufr.tables.BufrTables.addLookupFile(  yourLookupFileNameAsString) throws throws FileNotFoundException;
    }
